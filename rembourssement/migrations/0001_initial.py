    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('created', 'Created'), ('sent_to_merchant', 'Sent to Merchant'), ('processing_by_SMT', 'Processing by SMT'), ('processing_by_bank', 'Processing by Bank'), ('won', 'Won'), ('lost', 'Lost'), ('cancelled', 'Cancelled'), ('reactivate', 'Reactivate')], max_length=100, null=True, verbose_name='Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rembourssement', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='files', to='rembourssement.rembourssement')),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, null=True)),
                ('updated_at', models.DateTimeField(auto_now=True, null=True)),
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='re', to='rembourssement.comment')),
                ('rembourssement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='rembourssement.rembourssement')),
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='rembourssement_comments', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='ActionLog',
